...
.dropdown-trigger {
  @apply p-2 rounded-lg transition-all duration-200 border-none bg-transparent cursor-pointer;
  @apply hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2;
}
...
.dropdown-item {
  @apply flex items-center gap-3 px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 cursor-pointer transition-colors;
  @apply border-none bg-transparent w-full text-left;
}
