...
.base-badge--success { background: color-mix(in srgb, var(--ps-success) 20%, var(--ps-card)); border-color: color-mix(in srgb, var(--ps-success) 70%, var(--ps-border)); color: var(--ps-success-contrast, #053); }
.base-badge--warning { background: color-mix(in srgb, var(--ps-warning) 20%, var(--ps-card)); border-color: color-mix(in srgb, var(--ps-warning) 70%, var(--ps-border)); color: var(--ps-warning-contrast, #552); }
.base-badge--danger { background: color-mix(in srgb, var(--ps-danger) 20%, var(--ps-card)); border-color: color-mix(in srgb, var(--ps-danger) 70%, var(--ps-border)); color: var(--ps-danger-contrast, #520); }
