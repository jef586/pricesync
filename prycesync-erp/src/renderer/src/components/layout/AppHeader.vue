<template>
  <header
    class="h-10 flex items-center justify-between px-3 select-none app-region-drag border-b border-transparent bg-[var(--ps-header-bg)] text-[var(--ps-header-text)] fixed top-0 inset-x-0 z-[100]"
    role="banner"
  >
