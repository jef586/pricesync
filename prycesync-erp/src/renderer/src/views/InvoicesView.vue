  ...
  <DashboardLayout>
    <div class="invoices-view">
      ...
      <ConfirmModal
        ...
        :details="`Cliente: ${invoiceToDelete?.customer?.name || 'N/A'} | Total: ${invoiceToDelete ? formatCurrency(invoiceToDelete.total) : ''} | Estado: ${invoiceToDelete ? getStatusLabel(invoiceToDelete.status) : ''}`"
        variant="danger"
        confirm-text="Eliminar Factura"
